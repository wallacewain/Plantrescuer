...

{
  ...
  printf '%s\n' '<link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 64 64%22><circle cx=%2232%22 cy=%2232%22 r=%2232%22 fill=%22%231D2E24%22/><path d=%22M32 54V30%22 stroke=%22%237FC79A%22 stroke-width=%223%22 stroke-linecap=%22round%22/><path d=%22M32 36c-8 0-14-6-14-14 8 0 14 6 14 14Z%22 fill=%22%237FC79A%22/><path d=%22M32 42c8 0 14-6 14-14-8 0-14 6-14 14Z%22 fill=%22%237FC79A%22/></svg>">'
